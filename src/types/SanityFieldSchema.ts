...
export type ArraySanityFieldSchema = BaseSanityFieldSchema<'array', any[], {
  sortable?: boolean
  layout?: 'tag' | 'grid'
...
export type BlockSanityFieldSchema = BaseSanityFieldSchema<'block', Block, {
  spellCheck?: boolean
}, {
...
export type DateSanityFieldSchema = BaseSanityFieldSchema<'date', string, {
  dateFormat?: string
}>

export type DatetimeSanityFieldSchema = BaseSanityFieldSchema<'datetime', string, {
  dateFormat?: string
  timeFormat?: string
  timeStep?: number
}>

export type FileSanityFieldSchema = BaseSanityFieldSchema<'file', File, {
...
export type ImageSanityFieldSchema = BaseSanityFieldSchema<'image', Image, {
...
export type NumberSanityFieldSchema = BaseSanityFieldSchema<'number', number, {
...
export type ReferenceSanityFieldSchema = BaseSanityFieldSchema<'reference', Reference, {
  disableNew?: boolean
  filter?: string | ((params: CallbackParam) => ({
    filter: string
    filterParams?: any
  }))
  filterParams?: any
...
export type SlugSanityFieldSchema = BaseSanityFieldSchema<'slug', Slug, {
  source?: string
  maxLength?: number
...
export type StringSanityFieldSchema = BaseSanityFieldSchema<'string', string, {
  list?: string[] | {title:string;value:string}[]
  layout?: 'radio' | 'dropdown'
  direction?: 'horizontal' | 'vertical'
}>

export type TextSanityFieldSchema = BaseSanityFieldSchema<'text', string, {
}, {
  rows?: number
}>
...
export type BooleanSanityFieldSchema = BaseSanityFieldSchema<'boolean', boolean, {
...
export type AnySanityFieldSchema =
  AnySpecificSanityFieldSchema
  | BaseSanityFieldSchema<string>
