import {fileFieldSchemaFactory, imageFieldSchemaFactory, referenceFieldSchemaFactory, stringFieldSchemaFactory} from '@/helpers/sanity/fieldSchemaFactories'
...
export function contentfulFieldItemToSanityOfType(field: Exclude<ContentFields['items'], undefined>, data: ContentfulExport): LinkedType | null {
